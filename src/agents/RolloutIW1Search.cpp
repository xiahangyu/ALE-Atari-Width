...
RolloutIW1Search::RolloutIW1Search(RomSettings *rom_settings, Settings &settings,
	...
	/** Modified by xhy */
	std::cout<<"Using Rollout IW1 Search!"<<std::endl;
...
RolloutIW1Search::~RolloutIW1Search() {
...
/* *********************************************************************
   Builds a new tree
   ******************************************************************* */
void RolloutIW1Search::build(ALEState & state) {	
	assert(p_root == NULL);
...
void RolloutIW1Search::print_path(TreeNode * node, int a) {
...
void RolloutIW1Search::update_tree() {
	if(p_root->accumulated_reward < 0)
		p_root->accumulated_reward = 0;
	expand_tree(p_root);
}

void RolloutIW1Search::update_novelty_table( const BPROSFeature* m_bprosFeature, int depth){
...
bool RolloutIW1Search::check_novelty_1(BPROSFeature* m_bprosFeature, int depth){
...
void RolloutIW1Search::checkAndUpdate_novelty(TreeNode * curr_node, TreeNode * child, int a){
...
int RolloutIW1Search::expand_node( TreeNode* curr_node, queue<TreeNode*>& q )
{
...
/* *********************************************************************
   ...
   ******************************************************************* */
void RolloutIW1Search::expand_tree(TreeNode* start_node) {
...
void RolloutIW1Search::move_to_best_sub_branch() 
{
...
/* *********************************************************************
   ...
   ******************************************************************* */
void RolloutIW1Search::update_branch_return(TreeNode* node) {
...
void RolloutIW1Search::set_terminal_root(TreeNode * node) {
	node->branch_return = node->node_reward; 
...
void RolloutIW1Search::print_frame_data( int frame_number, float elapsed, Action curr_action, std::ostream& output )
{
