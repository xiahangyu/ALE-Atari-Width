...
public:
    ...
    /** Added by xhy. Displays the current game screen from alescreen*/
    void display_screen(const ALEScreen& screen);
...
protected:
    ...
    IntMatrix bg_matrix;
    int bg_histogram[SCREEN_HEIGHT][SCREEN_WIDTH][NUM_COLORS] = {{{0}}};
};
#else
