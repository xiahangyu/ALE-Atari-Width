...
CXX := g++
CXXFLAGS := -std=c++11 #-DPROTOBUF_DEPRECATED_ATTR=""  
LD := g++
# LIBS += -lz -lX11
# For the Mac
...
ifeq ("$(USE_CPPTF)", "1")
  ...
  LIBS += $(LIBS_CPPTF)
  INCLUDES += -I/usr/local/include/tf -I/usr/local/include/eigen3 -I/usr/local/Cellar/protobuf/3.5.1_1/include #-I/usr/local/include
endif
...
$(LIBRARY): $(OBJS)
	$(LD) $(LDFLAGS) -shared -o $(LIBRARY) $(LIBS) $(OBJS)        
