    ...
    def conv_decoder(pred_encode, cnn_shapes):
        with tf.variable_scope("training"):
            ...
            with tf.variable_scope("cnn_layers", reuse=tf.AUTO_REUSE):
                ...
                w2 = tf.get_variable("conv3_weights", [6, 6, 128, 128], initializer=tf.contrib.layers.xavier_initializer())
                ...
                w3 = tf.get_variable("conv2_weights", [6, 6, 64, 128], initializer=tf.contrib.layers.xavier_initializer())
                ...
                w4 = tf.get_variable("conv1_weights", [4, 4, 1, 64], initializer=tf.contrib.layers.xavier_initializer())
